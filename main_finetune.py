...
def get_args_parser():
    ...
    parser.add_argument('--finetune', default='/data/cchuang/emoset/masskfus0.751234/checkpoint-400.pth',
    ...
    parser.add_argument('--output_dir', default='/data/cchuang/emoset/maefinetunefi', type=str,
                        help='path where to save, empty for no saving')
    parser.add_argument('--dataset', default="CAER-S",
...
def main(args):
    ...
    # simple augmentation
    dataset_train, dataset_val = build_finetune_dataset(True, args)
